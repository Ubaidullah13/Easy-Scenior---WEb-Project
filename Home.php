      ...
      <section class="OurContainer Main-Section">
        ...
        <div class="row">
          ...
          <div class="col-xxl col-xl col-md col-sm-12 my-auto">
            <h5 id="TopLabel">#<?php echo $resHero['SubHeading'] ?></h5>
...
?>
    ...
    <section class="OurContainer Category-Section">
      <h2><?php echo $resSecond['Heading'] ?></h2>
      <!--  Text and Search  -->
      <div class="row">
        ...
        <div
          class="col-xxl col-xl col-lg-4 col-md-4 offset-lg-2 offset-md-1 col-sm-4 offset-sm-8 cat_search"
        >
          <div class="input-group">
            <input
              ...
              aria-describedby="search_category"
            />
      ...
      <div class="row">
        ...
        <div class="col-xxl col-xl-3 col-md-6 col">
          <div class="card category_card">
            <img
              src="res/Computer Science - category.svg"
              class="card-img-top"
        ...
        <div class="col-xxl col-xl-3 col-md-6 col">
          <div class="card category_card">
            <img
              src="res/Software Engineering - category.svg"
              class="card-img-top"
              alt="computer science"
            />
            <div class="card-body">
        ...
        <div class="col-xxl col-xl-3 col-md-6 col">
          <div class="card category_card">
            <img
              src="res/Electrical Engineering - category.svg"
              class="card-img-top"
              alt="computer science"
            />
            <div class="card-body">
        ...
        <div class="col-xxl col-xl-3 col-md-6 col">
          <div class="card category_card">
            <img
              src="res/business Analytics - category.svg"
              class="card-img-top"
              alt="computer science"
            />
            <div class="card-body">
...
?>
    ...
    <section class="OurContainer Tutor-Section">
      <div class="row">
        <div class="col-xxl-6 col-xl-7 col-md">
          <h5>#<?php echo $resTutor['SubHeading'] ?></h5>
          <h2><?php echo $resTutor['Heading'] ?></h2>
          <p>
        ...
        <div class="col-xxl col-xl col-md my-auto" id="offer">
          <div class="end">
            ...
            <img src="res/Home mentor.svg" /><span>One to one mentorship</span
            ><br />
            <img src="res/Home Test prep.svg" /><span
              >Entry Test preparation</span
            ><br />
            <img src="res/Home Online course.svg" /><span>Online course</span
            ><br />
          </div>
        </div>
      </div>
    ...
    <!-- How it works -->
    <section class="OurContainer TextCenter Works-Section">
      <h5>WORKS</h5>
      <h2>How it Works?</h2>
...
?>
        <div class="col-xxl col-xl col-md reviewCard FirstRC blog">
          <img
            ...
            src="<?php echo $resBlog['titleImage'] ?>"
            height="auto"
            width="100%"
          />
          ...
          <div class="row" style="float: right;">
            <div class="col-4 offset-1 my-auto"><image src="res/Heart.png" /></div>
            <div class="col my-auto"><p style="display: inline"><?php echo $resBlog['likes'] ?></p></div>
          </div>
        </div>
        <!--  2  -->
<?php
...
?>
        <div class="col-xxl col-xl col-md reviewCard SecondRC blog">
          <img
            ...
            width="100%"
          />
          <h5 style="color: #1c4a4a"><?php echo $resBlog['title'] ?></h5>
          <button type="button" class="btn btnPrimary btn-sm btnFont btnThird">
            Read More
          </button>
          <div class="row" style="float: right;">
